...
IGCSE.quiz = {
  ...
  description: 'Check your understanding of market economies, the price mechanism, and arguments for markets.',
  questions: [
    {
    ...
    },
    {
      id: 'choice-advantage',
      type: 'multipleChoice',
      prompt: 'Which example shows an advantage of a market economy?',
      choices: [
        'Many firms compete by offering different prices, styles, and quality levels.',
        'A private firm ignores pollution costs imposed on nearby residents.',
        'A public good is not provided because non-payers cannot be excluded.',
        'A monopoly restricts output and charges a high price.',
      ],
      answer: 0,
      explanation: 'Competition between firms can increase consumer choice in a market economy.',
    },
    {
      id: 'innovation',
      type: 'fillBlank',
      prompt: 'The profit incentive can encourage firms to improve quality and __________.',
      acceptedAnswers: ['innovation', 'innovate'],
      explanation: 'Firms may innovate to attract consumers and increase profit.',
    },
  ],
};
