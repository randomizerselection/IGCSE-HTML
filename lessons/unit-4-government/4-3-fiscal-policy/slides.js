/* ============================================================
   ...
   the macroeconomic aims in 4.1.1.
   ============================================================ */
...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      title:   'Today\'s route',
      items: [
        ['4.1.1', 'Aims', 'what government is trying to achieve'],
        ['4.2.1', 'Budget', 'revenue, expenditure, deficit, surplus'],
        ['4.2.2-4.2.3', 'Tools', 'spending areas and reasons for taxation'],
        ['4.2.4-4.2.6', 'Effects', 'how fiscal policy affects macro aims'],
      ],
...

    {
      ...
      subtitle: 'Fiscal policy is judged by what it helps the economy achieve.',
    },
    {
      type: 'cards',
      eyebrow: 'Macroeconomic aims',
      title:   'Six aims to remember',
      lead:    'Government spending and taxation can be used to influence these aims.',
      cards: [
        ['Economic growth', 'increase real GDP and output'],
        ['Employment', 'achieve full employment or low unemployment'],
        ['Stable prices', 'keep inflation low and predictable'],
        ['Balance of payments', 'avoid persistent current account problems'],
        ['Redistribution', 'reduce excessive income inequality'],
        ['Sustainability', 'protect environmental quality for the future'],
      ],
      visual: photos.budgetHearing,
    ...
    {
      type: 'cards',
      eyebrow: 'Macroeconomic conflicts',
      title:   'Aims can clash',
      lead:    'Good exam answers recognise that policy choices may improve one aim while harming another.',
      cards: [
        ['Employment vs inflation', 'higher demand may create jobs, but also price pressure'],
        ['Growth vs sustainability', 'more output may increase pollution or resource use'],
        ['Employment vs balance of payments', 'higher incomes may increase imports'],
      ],
      footer: 'Use "may" because outcomes are uncertain.',
    ...
    },
    {
      type: 'quiz',
      eyebrow: 'Aim check',
      title:   'Which aim is targeted?',
      question: 'The government raises tax on petrol and uses the revenue to subsidise buses.',
      choices: [
        'Environmental sustainability',
        'Redistribution of income',
        'Balance of payments stability',
      ],
      prompt: 'Explain why another aim could also be affected.',
      visual: photos.pollution,
      partialReview: ['.choices > .choice', '.prompt'],
    },
