...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      title:   'Model answer',
      question: 'Explain how a rise in interest rates may reduce inflation.',
      answer: 'A rise in interest rates increases the cost of borrowing and makes saving more attractive. Consumers and firms may spend less, so total spending in the economy falls. This reduces demand-pull pressure and may lower the inflation rate.',
      links: ['cost of borrowing', 'saving', 'spending', 'inflationary pressure'],
      markSchemeNote: 'This matches explain wording by developing the interest-rate transmission chain from borrowing and saving to spending and inflation.',
