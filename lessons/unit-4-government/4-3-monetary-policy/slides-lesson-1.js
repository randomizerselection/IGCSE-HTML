...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      cards: [
        { title: 'Bank to government', zhTitle: '政府的银行', body: 'manage government accounts and financial stability', icon: 'bank' },
        { title: 'Bank to banks', zhTitle: '银行的银行', body: 'support the banking system and act as lender of last resort', icon: 'bank' },
        { title: 'Issue currency', zhTitle: '发行货币', body: 'supply notes and coins', icon: 'payments' },
        { title: 'Monetary policy', zhTitle: '货币政策', body: 'use policy tools to influence macroeconomic aims', icon: 'macroeconomy' },
      ],
    ...
    },
    {
      ...
      cardStyle: 'compactVisual',
      cards: [
        { title: 'Economic growth', zhTitle: '经济增长', body: 'raise spending, output and investment', icon: 'growth' },
        { title: 'Employment', zhTitle: '就业', body: 'increase output and demand for labour', icon: 'employment' },
        { title: 'Stable prices', zhTitle: '价格稳定', body: 'reduce inflationary pressure', icon: 'prices' },
        { title: 'Current account', zhTitle: '经常账户', body: 'influence imports and exports', icon: 'currentAccount' },
      ],
