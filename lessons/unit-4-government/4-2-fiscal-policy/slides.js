...
IGCSE.lesson = {
  ...
  slides: [
    ...
    },
    {
      ...
      lead:    'Government spending can target different areas of the economy.',
      cards: [
        ...
        ['Debt interest', 'payments on previous borrowing'],
      ],
      visual: photos.budgetHearing,
    ...
    },
    {
      ...
      title:   'Education improves productivity',
      nodes: [['more education spending', 'workers gain skills', 'productivity may rise', 'long-run growth may increase']],
      footer: 'Cost: spending on education may mean less money for other services.',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for spending',
      title:   'Healthcare supports the labour force',
      nodes: [['more healthcare spending', 'people are healthier', 'absences may fall', 'output may rise']],
      footer: 'Cost: healthcare spending may require higher taxes or borrowing.',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for spending',
      title:   'Infrastructure supports growth',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for spending',
      title:   'Welfare redistributes income',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for spending',
      title:   'Defence provides security',
      nodes: [['more defence spending', 'security may improve', 'people and firms face less risk', 'economic activity is protected']],
      footer: 'Cost: defence spending has an opportunity cost.',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for spending',
      title:   'Debt interest pays for past borrowing',
      nodes: [['previous budget deficits', 'government borrowed money', 'interest must be paid', 'less money is available elsewhere']],
      footer: 'This spending is often unavoidable in the short run.',
      visual: photos.budgetMeeting,
      partialReview: ['.flowRow > .flowChip', '.prompt'],
    },
    {
    ...
    },
    {
      ...
      cards: [
        ['Raise revenue', 'fund government spending'],
        ['Demerit goods', 'reduce harmful consumption'],
        ['Reduce imports', 'make imports more expensive'],
        ['Redistribute income', 'reduce income inequality'],
        ['Influence demand', 'change total spending'],
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for taxation',
      title:   'Taxes reduce demerit goods',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for taxation',
      title:   'Tariffs can reduce imports',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for taxation',
      title:   'Taxes can redistribute income',
    ...
    },
    {
      type: 'flow',
      eyebrow: 'Reason for taxation',
      title:   'Taxes can influence demand',
